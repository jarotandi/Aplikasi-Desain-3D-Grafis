    ...
    <div className="min-h-screen gradient-hero flex items-center justify-center pt-16 px-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Mulai perjalanan kreatifmu</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-[#1a1a3a] border-purple-500/20 text-white placeholder:text-gray-500 focus:border-[#6C63FF]"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 bg-[#1a1a3a] border-purple-500/20 text-white placeholder:text-gray-500 focus:border-[#6C63FF]"
                    required
                  />
                  <button
                    type="button"
              ...
              <label className="flex items-start space-x-2 text-sm text-gray-400">
                <input
                  ...
                  className="mt-0.5 rounded border-purple-500/20 bg-[#1a1a3a] text-[#6C63FF]"
                />
                <span>
                  Saya setuju dengan{" "}
